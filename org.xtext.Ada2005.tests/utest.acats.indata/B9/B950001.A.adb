...
--
--      There are a couple of Ada 2012 cases commented out here:
--          The result of evaluating a qualified_expression is a constant;
--          Calls to procedure of a synchronized interface which are
...
-- The following only can be used in Ada 2012:
--   package Nested is
   ...
   protected body POT2 is
      ...
      begin
         case Int is
           ...
           -- The following cases are only for Ada 2012:
           ...
           --when 131 => Intf_In_Parm.PEN11;                           -- ERROR:
           --when 133 => Intf_In_Parm.PPN11;                           -- ERROR:
           --when 137 => Sink2(Intf_In_Parm.PPN11'access);             -- ERROR:
           --when 139 =>
           --   declare
           --      package GPE139 is new Gen1 (Intf_In_Parm.PEN11);    -- ERROR:
           --      package GPP139 is new Gen1 (Intf_In_Parm.PPN11);    -- ERROR:
           --      procedure RPE139 renames Intf_In_Parm.PEN11;        -- ERROR:
           --      procedure RPP139 renames Intf_In_Parm.PPN11;        -- ERROR:
           --   begin
           --      null;
           --   end;

           --when 141 => Intf_In_Out_Parm.PEN11;                       -- OK.
           --when 143 => Intf_In_Out_Parm.PPN11;                       -- OK.
           --when 147 => Sink2(Intf_In_Out_Parm.PPN11'access);         -- OK.
           --when 149 =>
           --   declare
           --      package GPE149 is new Gen1 (Intf_In_Out_Parm.PEN11);-- OK.
           --      package GPP149 is new Gen1 (Intf_In_Out_Parm.PPN11);-- OK.
           --      procedure RPE149 renames Intf_In_Out_Parm.PEN11;    -- OK.
           --      procedure RPP149 renames Intf_In_Out_Parm.PPN11;    -- OK.
           --   begin
           --      null;
           --   end;
