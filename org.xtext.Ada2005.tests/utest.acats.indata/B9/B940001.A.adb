...
--      Specifically: an anonymous array is not allowed
--
--
-- CHANGE HISTORY:
...
procedure B940001 is
   
   type A_Priority is (Low, Medium, High);
   
   protected Hold is
      procedure Set_Current_Priority;         
   private
      Current : array (A_Priority) of Boolean := (others => false);  -- ERROR: 
                                               -- anonymous arrays not allowed 
                                               -- in protected types
   end Hold;
