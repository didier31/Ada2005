...
--
--      Declare a library-level generic package which declares several
...
package BC70003_0 is                                   -- for formal package.
   Object : Element_Type;
end BC70003_0;
...
package BC70003_1 is                                   -- Non-generic package.
   Object : String (1 .. 5);
end BC70003_1;
...
generic                                                -- Generic subprogram.
   type Elem_Type is (<>);
procedure BC70003_2 (E : in out Elem_Type);


     --==================================================================--


procedure BC70003_2 (E : in out Elem_Type) is
begin
   null;
end BC70003_2;
...
with BC70003_0;  -- Generic package.                   -- Package instance.
package BC70003_3 is new BC70003_0 (Integer);
