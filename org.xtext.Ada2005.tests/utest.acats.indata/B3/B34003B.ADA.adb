...
-- PWN 10/27/95  REMOVED CHECKS FOR FLOATING POINT TYPE ATTRIBUTES NOW LEGAL.
-- PWN 01/16/96  RESTORED CHECKS IN ADA 95 LEGAL FORMAT.
--               K(181,238);6.0

WITH SYSTEM; USE SYSTEM;

PROCEDURE B34003B IS
...
BEGIN
     ...
     I := T'MACHINE_EMAX;               -- OK:    'MACHINE_EMAX.
     I := T'MACHINE_EMIN;               -- OK:    'MACHINE_EMIN.
     I := T'MACHINE_MANTISSA;           -- OK:    'MACHINE_MANTISSA.
