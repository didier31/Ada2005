...
-- (IMPLICITLY) FOR DERIVED LIMITED PRIVATE TYPES WITH DISCRIMINANTS.
...
BEGIN
     ...
     INIT (X, TRUE, 3, 2, "AAA", 2, 1.0);
     INIT (Y, TRUE, 3, 2, "AAA", 2, 1.0);
     INIT (Z, TRUE, 3, 2, "AAA", 2, 1.0);
     INIT (W, TRUE, 3, 2, "AAA", 2, 1.0);
