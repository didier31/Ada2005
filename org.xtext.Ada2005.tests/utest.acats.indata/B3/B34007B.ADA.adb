...
-- (IMPLICITLY) FOR DERIVED ACCESS TYPES WHOSE DESIGNATED TYPE IS NOT AN
-- ARRAY TYPE, A TASK TYPE, A RECORD TYPE, OR A TYPE WITH DISCRIMINANTS.
...
PROCEDURE B34007B IS
     ...
     X, Y, Z : T          := NEW DESIGNATED'(2);
     W       : PARENT     := NEW DESIGNATED'(2);
     C       : COMPONENT  := 1;
     H       : DESIGNATED := 1;
