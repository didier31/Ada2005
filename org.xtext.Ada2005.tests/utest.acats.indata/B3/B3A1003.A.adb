...
--     incomplete type declaration, a private type declaration, a
--     private extension, or a subtype declaration.
--
-- TEST DESCRIPTION:
--
...
procedure B3A1003 is
   ...
   package Pack2 is
      type T2;                               -- POSSIBLE ERROR: [Set03]
      type TT2 is tagged;                    -- POSSIBLE ERROR: [Set04]
      type T2 is private;                    -- POSSIBLE ERROR: [Set03]
      type TT2 is tagged private;            -- POSSIBLE ERROR: [Set04]
   private
   ...
   package Pack3 is
      type T3;                               -- POSSIBLE ERROR: [Set05]
      type TT3 is tagged;                    -- POSSIBLE ERROR: [Set06]
      type T3 is new A_Tagged with private;  -- POSSIBLE ERROR: [Set05]
      type TT3 is new A_Tagged with private; -- POSSIBLE ERROR: [Set06]
   private
   ...
   package Pack4 is
      type T4;                               -- POSSIBLE ERROR: [Set07]
      type TT4 is tagged;                    -- POSSIBLE ERROR: [Set08]
      subtype T4 is A_Tagged;                -- POSSIBLE ERROR: [Set07]
      subtype TT4 is A_Tagged;               -- POSSIBLE ERROR: [Set08]
   end Pack4;
   ...
   package Pack6 is
   private
      type T6;                               -- POSSIBLE ERROR: [Set09]
      type TT6 is tagged;                    -- POSSIBLE ERROR: [Set10]
   end Pack6;

   package body Pack6 is
      subtype T6 is A_Tagged;                -- POSSIBLE ERROR: [Set09]
      subtype TT6 is A_Tagged;               -- POSSIBLE ERROR: [Set10]
   end Pack6;
