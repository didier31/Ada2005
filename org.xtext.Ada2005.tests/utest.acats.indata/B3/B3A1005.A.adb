...
private
   ...
   -- The errors in the following are not one of the allowed uses of
   -- 3.10.1(5-9.2/2); 3.10.1(9.3/2) does not apply:

   type Normal_Inc;
   type Normal_Tagged_Inc is tagged;

   procedure Proc11 (A : Normal_Inc);                   -- ERROR:
   ...
   function Func11 return Normal_Inc;                   -- ERROR:

   function Func12 return Normal_Tagged_Inc;            -- ERROR:
