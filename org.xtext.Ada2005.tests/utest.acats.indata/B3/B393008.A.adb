...
package B393008 is
  ...
  type Branch_2 is abstract new Concrete_Root with null record;      -- OK

  function Dispatch_W_Controlling_Access_Result
      return access Branch_2 is abstract;                            -- OK
  ...
  function Dispatch_W_Controlling_Access_Result
      return access Abstract_Branch_2 is abstract;                  -- OK
  ...
  type Stem_3 is new Abstract_Branch_2 with null record;            -- ERROR:
         -- overriding function Dispatch_W_Controlling_Access_Result required
