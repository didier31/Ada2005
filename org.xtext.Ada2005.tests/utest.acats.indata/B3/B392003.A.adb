...
package B392003 is  
   ...
   procedure Proc (P1: New_Uncons_Tagged_1; P2 : integer);           -- ERROR:
   ...
   procedure Static_Match_Proc (P1 : Other_Uncons_Tagged; 
                                P2 : Other_Uncons_Sub);              -- OK

   procedure Non_Static_Match_Proc1 (P1 : Other_Uncons_Tagged; 
                                     P2 : Other_Cons_Sub_1);         -- ERROR:
                                       -- Parameter does not statically match.
  
   procedure Non_Static_Match_Proc2 (P2 : Other_Cons_Sub_2);         -- ERROR:
                                       -- Parameter does not statically match.
  
   procedure Non_Static_Match_Proc3 (P2 : Other_Cons_Sub_3);         -- ERROR:
                                       -- Parameter does not statically match.
  
   function Static_Match_Func1 (P1 : Other_Uncons_Tagged) 
     return Other_Uncons_Sub;                                        -- OK

   function Static_Match_Func2 (P1 : Other_Uncons_Sub) 
     return Other_Uncons_Tagged;                                     -- OK

   function Non_Static_Match_Func1 return Other_Cons_Sub_1;          -- ERROR:
                                          -- Result does not statically match.

   function Non_Static_Match_Func2 (P1 : Other_Cons_Sub_2)
     return Other_Uncons_Tagged;                                     -- ERROR:
                                       -- Parameter does not statically match.
   ...
   procedure Other_Proc1 (P1: New_More_Cons_Tagged_Sub_1);           -- ERROR:
                                       -- Parameter does not statically match.
   ...
   procedure Other_Proc2 (P1: New_More_Uncons_Tagged);               -- OK
   procedure Other_Proc3 (P1: New_More_Uncons_Tagged_Sub_1);         -- OK

   procedure Other_Proc4 (P1: New_More_Cons_Tagged_Sub);             -- ERROR:
                                       -- Parameter does not statically match.

private
   subtype Private_New_More_Uncons_Subtype is New_More_Uncons_Tagged (4);
   procedure Other_Proc5 (P1: Private_New_More_Uncons_Subtype);      -- ERROR:
                                       -- Parameter does not statically match.

   procedure Other_Proc6 (P1: New_More_Cons_Tagged_Sub);             -- ERROR:
                                       -- Parameter does not statically match.
end B392003;
