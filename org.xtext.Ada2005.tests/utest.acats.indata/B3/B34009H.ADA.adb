...
-- (IMPLICITLY) FOR DERIVED LIMITED PRIVATE TYPES WITHOUT DISCRIMINANTS.
...
PROCEDURE B34009H IS
     ...
     PACKAGE PKG IS
          ...
          PROCEDURE INIT (X : OUT PARENT; C : COMPONENT);

     PRIVATE

          TYPE PARENT IS NEW COMPONENT;
     ...
     PACKAGE BODY PKG IS
          ...
          PROCEDURE INIT (X : OUT PARENT; C : COMPONENT) IS
          BEGIN
               X := PARENT (C);
          END INIT;
