...
procedure B3A1001 is
   ...
   package Pack1B is
   private
      type UT1;                           -- POSSIBLE ERROR: [Set02] (1) for UT1.
   end Pack1B;
   ...
   procedure PROC2 is
      ...
      begin
         declare
            ...
            type WT7 is tagged null record;--POSSIBLE ERROR: [Set26] (3) for WT7.
         begin
            null;
         end;
      end Pack7B;
   ...
   task body Tsk3 is
      ...
      begin
         declare
            ...
            type WT8 is tagged null record;--POSSIBLE ERROR: [Set36] (3) for WT8.
         begin
            null;
         end;
      end Pack8B;
      procedure Proc3 is
         ...
         type XT8 is tagged null record;  -- POSSIBLE ERROR: [Set38] (3) for XT8.
      begin
         null;
      end Proc3;
      task type Tsk3A;
      task body Tsk3A is
         ...
         type YT8 is tagged null record;  -- POSSIBLE ERROR: [Set40] (3) for YT8.
      begin
         null;
      end Tsk3A;
   begin
   ...
   declare
      ...
      begin
         declare
            ...
            type WT9 is tagged null record;--POSSIBLE ERROR: [Set46] (3) for WT9.
         begin
            null;
         end;
      end Pack9B;
