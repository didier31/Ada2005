...
-- PART 2:  TYPES INVOLVING TYPE DERIVATION BUT NOT INVOLVING TASKING.
...
PROCEDURE  B45208I  IS

BEGIN

     -------------------------------------------------------------------
     -----------------  ACCESS TO A D(DISCRETE) TYPE  ------------------
     ...
     DECLARE
          ...
          TYPE  DERDISCR  IS NEW  DISCR ;

          TYPE  ACC  IS ACCESS  DERDISCR ;

          X  :  ACC := NEW  DERDISCR '( AA );
          Y  :  ACC := NEW  DERDISCR '( AA );
     ...
     -------------------------------------------------------------------
     ----------  D(RECORD WITH A DISCRETE-TYPE COMPONENT)  -------------
