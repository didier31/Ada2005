...
--      Declared Pure unit and on a Shared Passive unit.
--      The dependency on the Shared Passive unit should be flagged and 
...
with FXE2A00_1;                                                      -- ERROR:
                              -- Illegal dependency on shared passive package
...
package BXE2A01 is 
   ...
   subtype Not_So_Good is FXE2A00_1.Type_From_1;            -- OPTIONAL ERROR:
