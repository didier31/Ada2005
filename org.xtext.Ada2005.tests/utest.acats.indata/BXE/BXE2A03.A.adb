...
--      Declared Pure unit and on an unrestricted library unit.
--      The dependency on the unrestricted unit should be flagged and that
--      on the Declared Pure unit should be allowed.
--
-- TEST FILES:
