...
-- CASE C: THE DECLARATION IS IN A LIBRARY PACKAGE VISIBLE PART AND THE
--         BODY IS IN THE CORRESPONDING PACKAGE BODY, WHICH IS
--         SEPARATELY COMPILED; FOR NON-GENERIC SUBPROGRAMS.
...
-- SEPARATE FILES ARE:
--   B63009C0  A LIBRARY PACKAGE DECLARATION.
--   B63009C1  A LIBRARY PACKAGE DECLARATION (WITH SUBPROGRAM DECLS).
--   B63009C2  A LIBRARY PACKAGE BODY (B63009C1, WITH SUBPROG BODIES).
--   B63009C3M A DUMMY MAIN PROCEDURE.

-- JRK 2/24/84

WITH B63009C1; USE B63009C1;

PROCEDURE B63009C3M IS
