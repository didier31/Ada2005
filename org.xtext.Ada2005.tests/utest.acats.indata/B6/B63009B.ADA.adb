...
-- CASE B: THE DECLARATION IS IN A PACKAGE VISIBLE PART AND THE BODY IS
--         IN THE CORRESPONDING PACKAGE BODY, WHICH IS NOT SEPARATELY
--         COMPILED; FOR NON-GENERIC SUBPROGRAMS.
...
PROCEDURE B63009B IS
     ...
     PACKAGE PACK1 IS
          ...
          PACKAGE P5 IS
               V1 : I RENAMES B63009B.V1;
               SUBTYPE I IS B63009B.I;
          END P5;
     ...
     PACKAGE BODY PACK1 IS
         ...
         PROCEDURE T9C (D : I2 := "+"(2,0)) IS  -- OK by Ada95 rules
          ...
          PROCEDURE T17 (D : B63009B.P3.T) IS     -- OK: (I)
                                                  --   B63009B.P3.T.
               BEGIN NULL; END;
