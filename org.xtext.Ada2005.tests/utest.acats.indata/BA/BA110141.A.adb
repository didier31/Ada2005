...
package BA11014_A is
    ...
    procedure P4 (X4 : BA11014.T4); -- ERROR:
    type T5 is new BA11014.T5 with null record; -- ERROR:
    function F6 return BA11014.T6; -- ERROR:
    ...
    procedure P4 (X4 : BA11014.P.T4); -- ERROR:
    type Pt5 is new BA11014.P.T5 with null record; -- ERROR:
    function F6 return BA11014.P.T6; -- ERROR:
    ...
    procedure P4 (X4 : BA11014.P.Q.T4); -- ERROR:
    type Pqt5 is new BA11014.P.Q.T5 with null record; -- ERROR:
    function F6 return BA11014.P.Q.T6; -- ERROR:
