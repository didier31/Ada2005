...
--     SPECIFICATION. THIS FILE IS TO BE COMPILED AFTER BA1010N0M.ADA.
...
-- HISTORY:
--     THS 04/12/90  CREATED TEST FROM SPLIT OF BA1010D5.ADA.

PROCEDURE BA1010N (I : INTEGER; BA1010N : OUT INTEGER) IS     -- ERROR:
BEGIN                                            -- DOESN'T MATCH SPEC.
     BA1010N := 5;
END BA1010N;
