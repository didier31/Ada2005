...
--     SPECIFICATION. THIS FILE IS TO BE COMPILED AFTER BA1010M0M.ADA.
...
-- HISTORY:
--     THS 04/12/90  CREATED TEST FROM SPLIT OF BA1010D8.ADA.

PROCEDURE BA1010M (I : IN INTEGER; J : OUT POSITIVE) IS       -- ERROR:
