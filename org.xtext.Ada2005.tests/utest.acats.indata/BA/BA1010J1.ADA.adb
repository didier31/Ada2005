...
--     SPECIFICATION. THIS FILE MUST BE COMPILED AFTER BA1010J0M.ADA.
...
-- HISTORY:
--     THS 03/30/90  CREATED TEST FROM SPLIT OF BA1010D1.ADA.

PROCEDURE BA1010J (I : IN OUT INTEGER) IS -- ERROR: DOESN'T MATCH SPEC.
BEGIN
     I := 0;
END BA1010J;
