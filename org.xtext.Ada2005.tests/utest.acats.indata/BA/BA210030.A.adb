...
--      29 Jun 98   EDS     Moved subunit body of package Bad_Subunit to
--                          file BA210031.A.  Renamed files accordingly.
--      22 Mar 07   RLB     Ensured that My_Controlled does not have
--                          preelaborable initialization.
--!

with Ada.Finalization;  -- Preelaborated unit.
package BA21003_0 is
   ...
   procedure Initialize (Obj : in out My_Controlled);

   generic                                      -- Generic package subunit.
      type FP is private;
   package Bad_Subunit is
      IntObj : My_Int;
   end Bad_Subunit;

   package Subunit_BadWith is                   -- Package subunit.
      procedure Proc (P: in out My_Int);
   end Subunit_BadWith;
