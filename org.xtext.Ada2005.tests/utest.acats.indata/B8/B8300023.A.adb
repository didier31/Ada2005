...
-- The following hierararchy is identical to the previous one,
-- with names "Pub" replaced by "Priv", and all the packages private.

private package B8300025_1.Priv is
